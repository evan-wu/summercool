...
public abstract class MutipleOutputFormat<K, V> extends FileOutputFormat<K, V>{
	 ...
	 * @throws IOException
	 */
	public RecordWriter<K, V> getRecordWriter(FileSystem fs, Job job,
	      ...
	      // a cache storing the record writers for different output files.
			...
			public void write(K key, V value) throws IOException,
				...
				if (rw == null) {
					...
					rw = getBaseRecordWriter(myFS, myJob, finalPath,
							myProgressable);
	   ...
	   */
	  protected String getInputFileBasedOutputFileName(Job job, String name) {
	    String infilepath = job.getConfiguration().get("map.input.file");
	    if (infilepath == null) {
	  ...
	  abstract protected RecordWriter<K, V> getBaseRecordWriter(FileSystem fs,
	      Job job, String name, Progressable arg3) throws IOException;
