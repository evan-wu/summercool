...
public class CompressionTools {
	...
	public static byte[] compress(byte[] value, int offset, int length, int compressionLevel) {
		...
		/*
		 * Create an expandable byte array to hold the compressed data. You cannot use an array that's the same size as
		 * the orginal because there is no guarantee that the compressed data will be smaller than the uncompressed
		 * data.
		 */
