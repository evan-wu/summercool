...
/**
 * Datetime   ： 2011-5-11 下午05:01:31<br>
 * Title      :  WebmacroBase64BeanDefinition.java<br>
 * Description:   <br>
 ...
 *
 */
public abstract class WebmacroBase64BeanDefinition {
	...
	final public static String decode(byte[] encoded) {
		...
		while (epos < encoded.length) {
			...
			/*
			 * base64 decoding: turn 46 bits into 38 bits via the pattern: xx111111 xx112222 xx222233 xx333333 (xx: high
			 * bits unused)
			 */
	...
	final static public String encode(byte[] plain) {
		...
		/*
		 * base64 encoding: turn 38 bits into 46 bits via the pattern: 111111 112222 222233 333333 (xx: high bits
	...
	/**
	 * Translate a character in the base64 alphabet into a byte with the corresponding bits set (ie: a number from 0 to
	 * 64).
	 * 
