...
import com.bdconsulting.summercool.util.UriTemplateUtils;
 ...
 * 
 */
public class FreeMarkerUrlFunction implements TemplateMethodModelEx {
	...
	public Object exec(List arguments) throws TemplateModelException {
		if (arguments == null || arguments.size() == 0) {
			throw new TemplateModelException("url()函数有且只能有一到三个参数:(String uriTemplateModule, [Map<String, Object> params], [int seq])");
		}
		if (urlBuilderBeanMap == null || urlBuilderBeanMap.size() == 0) {
			throw new TemplateModelException("属性Map<String, List<DefaultUrlBuilderBeanDefinition>> urlBuilderBeanMap为空!");
		}
		...
		if (arguments.size() == 1) {
			...
			if (!(arg0 instanceof String) || !(arg1 instanceof Map || arg1 instanceof Integer)) {
				throw new TemplateModelException("url()函数有且只能有一到三个参数:(String uriTemplateModule, [Map<String, Object> params], [int seq])");
			}
			uriTemplateModule = (String) arg0;
			if (arg1 instanceof Map) {
				params = (Map) arg1;
				FreeMarker.validateMapKeysForString(params);
			}
			...
			if (!(arg0 instanceof String) || !(arg1 instanceof Map) || !(arg2 instanceof Integer)) {
				throw new TemplateModelException("url()函数有且只能有一到三个参数:(String uriTemplateModule, [Map<String, Object> params], [int seq])");
			}
			uriTemplateModule = (String) arg0;
			params = (Map) arg1;
	 ...
	 * @return
	 */
	private String findUri(String uriTemplateModule, Map<String, Object> params, Integer seq)
