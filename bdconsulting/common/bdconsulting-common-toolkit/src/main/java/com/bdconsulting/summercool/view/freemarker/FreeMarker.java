...
public abstract class FreeMarker {
	...
	public static Map<String, LocaleBean> SUPPORTED_LANGUAGE_MAP;
	
	public static Map<String, LocaleBean> SUPPORTED_LOCALE_LANGUAGE_MAP;
	 ...
	 * @param map
	 */
	public static void validateMapKeysForString(Map<Object, Object> map) {
